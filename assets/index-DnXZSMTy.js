var b=Object.defineProperty;var f=(n,e,a)=>e in n?b(n,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):n[e]=a;var l=(n,e,a)=>f(n,typeof e!="symbol"?e+"":e,a);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&t(o)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function t(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();class C{constructor(){l(this,"element");l(this,"backdrop");l(this,"dialogCard");l(this,"currentMode","login");l(this,"isOpen",!1);l(this,"handleKeyDown",e=>{e.key==="Escape"&&this.close()});this.backdrop=document.createElement("div"),this.backdrop.className="auth-backdrop",this.dialogCard=document.createElement("div"),this.dialogCard.className="auth-dialog",this.backdrop.append(this.dialogCard),this.element=this.backdrop,this.renderContent(),this.attachEvents()}getElement(){return this.element}open(e="login"){this.currentMode=e,this.renderContent(),document.body.append(this.element),this.isOpen=!0,requestAnimationFrame(()=>{this.backdrop.classList.add("auth-backdrop--active"),this.dialogCard.classList.add("auth-dialog--active")}),document.addEventListener("keydown",this.handleKeyDown)}close(){this.isOpen&&(this.backdrop.classList.remove("auth-backdrop--active"),this.dialogCard.classList.remove("auth-dialog--active"),setTimeout(()=>{this.element.parentNode&&this.element.remove(),this.isOpen=!1},250),document.removeEventListener("keydown",this.handleKeyDown))}attachEvents(){this.backdrop.addEventListener("click",e=>{e.target===this.backdrop&&this.close()})}switchMode(e){if(this.currentMode===e)return;this.currentMode=e;const a=this.dialogCard.querySelector(".auth-dialog__form-container");a?(a.classList.add("auth-dialog__form-container--transitioning"),setTimeout(()=>{this.renderContent();const t=this.dialogCard.querySelector(".auth-dialog__form-container");t&&t.classList.remove("auth-dialog__form-container--transitioning")},150)):this.renderContent()}renderContent(){const e=this.currentMode==="login";this.dialogCard.innerHTML=`
    ...
    `;const a=this.dialogCard.querySelectorAll(".auth-dialog__switcher-btn");for(const o of a)o.addEventListener("click",()=>{const r=o.dataset.mode;this.switchMode(r)});const t=this.dialogCard.querySelectorAll(".auth-switch-link");for(const o of t)o.addEventListener("click",r=>{r.preventDefault();const c=o.dataset.mode;this.switchMode(c)});const s=this.dialogCard.querySelectorAll(".auth-field__toggle-pwd");for(const o of s)o.addEventListener("click",()=>{var c;const r=(c=o.parentElement)==null?void 0:c.querySelector("input");if(r){const u=r.type==="password";r.type=u?"text":"password",o.innerHTML=u?this.getEyeOffIconSvg():this.getEyeIconSvg()}});const i=this.dialogCard.querySelector("form");i&&i.addEventListener("submit",o=>{o.preventDefault()})}renderLoginForm(){return`
    ...
    `;const i=document.createElement("button");i.className="btn btn--outline site-header__login-btn",i.textContent="Log In",i.addEventListener("click",()=>{var d,h;this.closeMobileMenu(),(h=(d=this.callbacks).onLoginClick)==null||h.call(d)});const o=document.createElement("button");o.className="btn btn--primary site-header__signup-btn",o.textContent="Sign Up",o.addEventListener("click",()=>{var d,h;this.closeMobileMenu(),(h=(d=this.callbacks).onSignUpClick)==null||h.call(d)});const r=document.createElement("div");r.className="site-header__nav-wrapper",r.append(s,i),this.burgerButton=document.createElement("button"),this.burgerButton.className="site-header__burger-btn",this.burgerButton.setAttribute("aria-label","Toggle menu"),this.burgerButton.innerHTML=`
      <span class="site-header__burger-icon">
        <span class="site-header__burger-line"></span>
        <span class="site-header__burger-line"></span>
        <span class="site-header__burger-line"></span>
      </span>
    `;const c=document.createElement("div");c.className="site-header__right-controls",c.append(r,o,this.burgerButton),a.append(t,c),e.append(a),this.mobileMenuOverlay=document.createElement("div"),this.mobileMenuOverlay.className="mobile-menu",this.mobileMenuOverlay.innerHTML=`
    ...
    `;const t=["narrow","normal","wide","normal","narrow"],s=()=>{const r=e.querySelector(".carousel-section__track");r&&(r.innerHTML=a.map((c,u)=>`
              <div class="game-card game-card--${t[u]||"normal"}" tabindex="0" role="group" aria-label="${c.title}">
                <img src="${c.image}" alt="${c.title}" class="game-card__image" />
                <div class="game-card__overlay">
                  <div class="game-card__info">
                    <h3 class="game-card__title">${c.title}</h3>
    ...
    `,e}}class z{constructor(e){l(this,"routes",[]);l(this,"rootElement");this.rootElement=e,window.addEventListener("popstate",()=>{this.handleRoute()})}addRoute(e){this.routes.push(e)}navigate(e){window.history.pushState({},"",e),this.handleRoute()}handleRoute(){const e=window.location.pathname,a=this.routes.find(t=>t.path===e);if(this.rootElement.innerHTML="",a)this.rootElement.append(a.render());else{const t=this.routes.find(s=>s.path==="*"||s.path==="/");t&&this.rootElement.append(t.render())}}}function j(){const n=document.querySelector("#app");if(!n)return;const e=new z(n);e.addRoute({path:"/",render:()=>{const a=document.createElement("div");a.className="app-container";const t=new C,s=new S({onLoginClick:()=>{t.open("login")},onSignUpClick:()=>{t.open("register")}});a.append(s.getElement());const i=document.createElement("main");i.className="main-content";const o=new I,r=new R,c=new Z,u=new D;i.append(o.getElement(),r.getElement(),c.getElement(),u.getElement());const m=new E;return a.append(i,m.getElement()),a}}),e.handleRoute()}document.addEventListener("DOMContentLoaded",()=>{j()});
