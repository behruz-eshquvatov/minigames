var F=Object.defineProperty;var B=(g,e,s)=>e in g?F(g,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):g[e]=s;var r=(g,e,s)=>B(g,typeof e!="symbol"?e+"":e,s);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function s(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerPolicy&&(i.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?i.credentials="include":t.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(t){if(t.ep)return;t.ep=!0;const i=s(t);fetch(t.href,i)}})();class H{constructor(){r(this,"element");r(this,"backdrop");r(this,"dialogCard");r(this,"currentMode","login");r(this,"isOpen",!1);r(this,"handleKeyDown",e=>{e.key==="Escape"&&this.close()});this.backdrop=document.createElement("div"),this.backdrop.className="auth-backdrop",this.dialogCard=document.createElement("div"),this.dialogCard.className="auth-dialog",this.backdrop.append(this.dialogCard),this.element=this.backdrop,this.renderContent(),this.attachEvents()}getElement(){return this.element}open(e="login"){this.currentMode=e,this.renderContent(),document.body.append(this.element),this.isOpen=!0,requestAnimationFrame(()=>{this.backdrop.classList.add("auth-backdrop--active"),this.dialogCard.classList.add("auth-dialog--active")}),document.addEventListener("keydown",this.handleKeyDown)}close(){this.isOpen&&(this.backdrop.classList.remove("auth-backdrop--active"),this.dialogCard.classList.remove("auth-dialog--active"),setTimeout(()=>{this.element.parentNode&&this.element.remove(),this.isOpen=!1},250),document.removeEventListener("keydown",this.handleKeyDown))}attachEvents(){this.backdrop.addEventListener("click",e=>{e.target===this.backdrop&&this.close()})}switchMode(e){if(this.currentMode===e)return;this.currentMode=e;const s=this.dialogCard.querySelector(".auth-dialog__form-container");s?(s.classList.add("auth-dialog__form-container--transitioning"),setTimeout(()=>{this.renderContent();const a=this.dialogCard.querySelector(".auth-dialog__form-container");a&&a.classList.remove("auth-dialog__form-container--transitioning")},150)):this.renderContent()}renderContent(){const e=this.currentMode==="login";this.dialogCard.innerHTML=`
    ...
    `;const s=this.dialogCard.querySelectorAll(".auth-dialog__switcher-btn");for(const n of s)n.addEventListener("click",()=>{const m=n.dataset.mode;this.switchMode(m)});const a=this.dialogCard.querySelectorAll(".auth-switch-link");for(const n of a)n.addEventListener("click",m=>{m.preventDefault();const h=n.dataset.mode;this.switchMode(h)});const t=this.dialogCard.querySelectorAll(".auth-field__toggle-pwd");for(const n of t)n.addEventListener("click",()=>{var h;const m=(h=n.parentElement)==null?void 0:h.querySelector("input");if(m){const o=m.type==="password";m.type=o?"text":"password",n.innerHTML=o?this.getEyeOffIconSvg():this.getEyeIconSvg()}});const i=this.dialogCard.querySelector("form");i&&i.addEventListener("submit",n=>{n.preventDefault()})}renderLoginForm(){return`
    ...
    `,a.addEventListener("click",d=>{var l,f;d.preventDefault(),this.setActivePage("home"),(f=(l=this.callbacks).onNavigate)==null||f.call(l,"home")});const t=document.createElement("nav");t.className="site-header__nav",t.innerHTML=`
    ...
    `;const i=t.querySelector('[data-page="home"]');i&&i.addEventListener("click",d=>{var l,f;d.preventDefault(),this.setActivePage("home"),(f=(l=this.callbacks).onNavigate)==null||f.call(l,"home")});const n=t.querySelector('[data-page="library"]');n&&n.addEventListener("click",d=>{var l,f;d.preventDefault(),this.setActivePage("library"),(f=(l=this.callbacks).onNavigate)==null||f.call(l,"library")});const m=document.createElement("button");m.className="btn btn--outline site-header__login-btn",m.textContent="Log In",m.addEventListener("click",()=>{var d,l;this.closeMobileMenu(),(l=(d=this.callbacks).onLoginClick)==null||l.call(d)});const h=document.createElement("button");h.className="btn btn--primary site-header__signup-btn",h.textContent="Sign Up",h.addEventListener("click",()=>{var d,l;this.closeMobileMenu(),(l=(d=this.callbacks).onSignUpClick)==null||l.call(d)});const o=document.createElement("div");o.className="site-header__nav-wrapper",o.append(t,m),this.burgerButton=document.createElement("button"),this.burgerButton.className="site-header__burger-btn",this.burgerButton.setAttribute("aria-label","Toggle menu"),this.burgerButton.innerHTML=`
      <span class="site-header__burger-icon">
        <span class="site-header__burger-line"></span>
        <span class="site-header__burger-line"></span>
        <span class="site-header__burger-line"></span>
      </span>
    `;const _=document.createElement("div");_.className="site-header__right-controls",_.append(o,h,this.burgerButton),s.append(a,_),e.append(s),this.mobileMenuOverlay=document.createElement("div"),this.mobileMenuOverlay.className="mobile-menu",this.mobileMenuOverlay.innerHTML=`
          ...
          <div class="game-card__info">
            ...
            <div class="game-card__meta">
              ...
              <span class="game-card__likes">
                <img src="${M}" alt="Likes" class="game-card__like-icon" width="20" height="20" />
            ...
            <tbody>
              ${s.map(a=>`
                <tr class="leaderboard-row leaderboard-row--rank-${a.rank}">
                  ...
                  <td class="col-score">
                    <span class="score-desktop">${S(a.totalScore,!1)}</span>
                    <span class="score-mobile">${S(a.totalScore,!0)}</span>
                  </td>
                  <td class="col-streak">
    ...
    `,e}}const fe=""+new URL("camper-van-make-it-home-card-61XprhL7.jpg",import.meta.url).href,be=Object.freeze(Object.defineProperty({__proto__:null,default:fe},Symbol.toStringTag,{value:"Module"})),ve=""+new URL("cast-n-chill-card-CRLWRuq0.jpg",import.meta.url).href,ye=Object.freeze(Object.defineProperty({__proto__:null,default:ve},Symbol.toStringTag,{value:"Module"})),ke=""+new URL("cat-chess-card-BkETDAfr.jpg",import.meta.url).href,Ce=Object.freeze(Object.defineProperty({__proto__:null,default:ke},Symbol.toStringTag,{value:"Module"})),we=""+new URL("cozy-solitaire-card-CSczvhq9.jpg",import.meta.url).href,Le=Object.freeze(Object.defineProperty({__proto__:null,default:we},Symbol.toStringTag,{value:"Module"})),Se=""+new URL("cozy-sudoku-card-CyAOOis5.jpg",import.meta.url).href,Ee=Object.freeze(Object.defineProperty({__proto__:null,default:Se},Symbol.toStringTag,{value:"Module"})),Me=""+new URL("grimshire-card-D1QcLtZT.jpg",import.meta.url).href,Ae=Object.freeze(Object.defineProperty({__proto__:null,default:Me},Symbol.toStringTag,{value:"Module"})),je=""+new URL("koroneko-card-BXvG49TG.jpg",import.meta.url).href,xe=Object.freeze(Object.defineProperty({__proto__:null,default:je},Symbol.toStringTag,{value:"Module"})),ze=""+new URL("leaf-it-alone-card-CGXXB8uI.jpg",import.meta.url).href,Te=Object.freeze(Object.defineProperty({__proto__:null,default:ze},Symbol.toStringTag,{value:"Module"})),Pe=""+new URL("leafy-corner-card-CAdJaXNI.jpg",import.meta.url).href,Ie=Object.freeze(Object.defineProperty({__proto__:null,default:Pe},Symbol.toStringTag,{value:"Module"})),Oe=""+new URL("little-corners-card-BzTzTJLT.jpg",import.meta.url).href,De=Object.freeze(Object.defineProperty({__proto__:null,default:Oe},Symbol.toStringTag,{value:"Module"})),Fe=""+new URL("organized-inside-card-CyWIV6Rk.jpg",import.meta.url).href,Be=Object.freeze(Object.defineProperty({__proto__:null,default:Fe},Symbol.toStringTag,{value:"Module"})),He=""+new URL("the-wild-at-heart-card-DfO3UIaM.jpg",import.meta.url).href,Re=Object.freeze(Object.defineProperty({__proto__:null,default:He},Symbol.toStringTag,{value:"Module"})),$e=""+new URL("tukoni-forest-keepers-card-CkPF-Hda.jpg",import.meta.url).href,Ne=Object.freeze(Object.defineProperty({__proto__:null,default:$e},Symbol.toStringTag,{value:"Module"})),Ge=""+new URL("whisper-of-the-house-card-BE7Dq45b.jpg",import.meta.url).href,qe=Object.freeze(Object.defineProperty({__proto__:null,default:Ge},Symbol.toStringTag,{value:"Module"})),Ue=""+new URL("wytchwood-card-XvNmJ299.jpg",import.meta.url).href,Ve=Object.freeze(Object.defineProperty({__proto__:null,default:Ue},Symbol.toStringTag,{value:"Module"})),We=[{slug:"all",label:"All Games",isDefault:!0},{slug:"puzzle",label:"Puzzle",isDefault:!1},{slug:"card",label:"Card",isDefault:!1},{slug:"match",label:"Match",isDefault:!1},{slug:"farm",label:"Farm",isDefault:!1},{slug:"strategy",label:"Strategy",isDefault:!1},{slug:"arcade",label:"Arcade",isDefault:!1}],Ze={data:We},Ke=[{slug:"vacation-cafe-simulator",name:"Vacation Cafe Simulator",category:"strategy",price:"Free",shortDescription:"Cozy Italian Vacation Cafe 🏖️ No timers, No stress 😌 cook traditional dishes 🍝 upgrade and customize 🏠 just drink Prosecco 🥂 relax and grow your dream cafe ✨",rating:4.8,likesCount:28750,cardImage:"/assets/images/games/vacation-cafe-simulator-card.jpg",featured:!0},{slug:"winter-burrow",name:"Winter Burrow",category:"farm",price:"Free",shortDescription:"A cozy woodland survival game about a mouse restoring their childhood burrow. Explore, gather resources, craft, knit warm sweaters, bake pies and meet the locals.",rating:4.9,likesCount:32400,cardImage:"/assets/images/games/winter-burrow-card.jpg",featured:!0},{slug:"shelve-the-potions",name:"Shelve the Potions!",category:"puzzle",price:"Free",shortDescription:"Organize 2000+ potions on shelves after the witch's cats have knocked them over, using clues around an enchanted cellar. Learn strange symbols and decipher cryptic notes.",rating:4.7,likesCount:21300,cardImage:"/assets/images/games/shelve-the-potions-card.jpg",featured:!0},{slug:"heartopia",name:"Heartopia",category:"strategy",price:"$1.99",shortDescription:"A multiplayer life simulation game crafted for creativity, freedom, and peace. Build your dream home, explore hobbies, and forge warm connections with friends in a cozy town.",rating:4.6,likesCount:46800,cardImage:"/assets/images/games/heartopia-card.jpg",featured:!0},{slug:"palia",name:"Palia",category:"strategy",price:"Free",shortDescription:"A free-to-play fantasy life sim adventure where you can craft, explore, and create the life and home of your dreams in a vibrant, heartwarming world.",rating:4.8,likesCount:89500,cardImage:"/assets/images/games/palia-card.jpg",featured:!0},{slug:"cat-mail-co",name:"Cat Mail Co.",category:"puzzle",price:"Free",shortDescription:"Run a cozy cat post office. Sort and deliver parcels from the daily boat. At night, the moon reveals hidden truths about packages. Clear a strange backlog and unlock new destinations.",rating:4.9,likesCount:38200,cardImage:"/assets/images/games/cat-mail-co-card.jpg",featured:!0},{slug:"leaf-it-alone",name:"Leaf it Alone",category:"arcade",price:"Free",shortDescription:"Finally, it's that time of the year to clean up this leafy mess. Derust your raking skills and don't waste a second — there's a whole lawn waiting!",rating:4.4,likesCount:12600,cardImage:"/assets/images/games/leaf-it-alone-card.jpg",featured:!1},{slug:"leafy-corner",name:"Leafy Corner",category:"farm",price:"$1.99",shortDescription:"Run a cute little plant shop. Grow, sell, and care for real-life plants, help customers find their dream plants, complete orders, and customize your cozy shop.",rating:4.7,likesCount:19800,cardImage:"/assets/images/games/leafy-corner-card.jpg",featured:!1},{slug:"grimshire",name:"Grimshire",category:"strategy",price:"Free",shortDescription:"A deadly plague threatens the village of Grimshire. Manage farmland, forage wilds, stop harvest rot and keep the cellar full. Can you help the community survive?",rating:4.6,likesCount:15700,cardImage:"/assets/images/games/grimshire-card.jpg",featured:!1},{slug:"tiny-glade",name:"Tiny Glade",category:"arcade",price:"$3.99",shortDescription:"A small diorama builder where you doodle whimsical castles, cozy cottages & romantic ruins. No management, combat or goals — just lovable dioramas.",rating:4.9,likesCount:67300,cardImage:"/assets/images/games/tiny-glade-card.jpg",featured:!0},{slug:"whisper-of-the-house",name:"Whisper of the House",category:"puzzle",price:"Free",shortDescription:"A cozy organizing & decorating game. Help townspeople move, organize, and clean their spaces. Your gentle touch may change their lives and uncover hidden stories.",rating:4.8,likesCount:24900,cardImage:"/assets/images/games/whisper-of-the-house-card.jpg",featured:!1},{slug:"tukoni-forest-keepers",name:"Tukoni: Forest Keepers",category:"puzzle",price:"Free",shortDescription:"A cute cozy puzzle adventure. Play as a forest spirit exploring hand-drawn magical locations, meet charming characters, solve puzzles, collect herbs and tea recipes.",rating:4.9,likesCount:31200,cardImage:"/assets/images/games/tukoni-forest-keepers-card.jpg",featured:!1},{slug:"cat-chess",name:"Cat Chess",category:"strategy",price:"Free",shortDescription:"Play the ancient and thrilling game of Chess but with... cats! Lead your furry friends to the Purrfect battle of brains and whiskers!",rating:4.6,likesCount:17400,cardImage:"/assets/images/games/cat-chess-card.jpg",featured:!1},{slug:"cast-n-chill",name:"Cast n Chill",category:"arcade",price:"Free",shortDescription:"A relaxing fishing game where you explore serene lakes, rivers, and oceans. Catch rare fish, upgrade your gear and reel in legendary catches - all with your loyal companion.",rating:4.7,likesCount:26800,cardImage:"/assets/images/games/cast-n-chill-card.jpg",featured:!1},{slug:"little-corners",name:"Little Corners",category:"puzzle",price:"Free",shortDescription:"Peel, place, and arrange stickers across tiny windows into different worlds. Relax and unwind to lofi beats, collect unique stickers and share cozy creations.",rating:4.8,likesCount:41500,cardImage:"/assets/images/games/little-corners-card.jpg",featured:!1},{slug:"tailside-cozy-cafe-sim",name:"Tailside: Cozy Cafe Sim",category:"strategy",price:"Free",shortDescription:"Run your own cozy café in Tailside! Brew coffee, decorate your café, follow small stories in the daily newspaper. Unlock new items, skills, villagers, and creature visitors.",rating:4.8,likesCount:35600,cardImage:"/assets/images/games/tailside-cozy-cafe-sim-card.jpg",featured:!0},{slug:"islanders-new-shores",name:"ISLANDERS: New Shores",category:"strategy",price:"Free",shortDescription:"Build your island retreat in a calm, minimalist world with exciting new features that keep the classic charm while inspiring fresh creativity.",rating:4.9,likesCount:54200,cardImage:"/assets/images/games/islanders-new-shores-card.jpg",featured:!0},{slug:"camper-van-make-it-home",name:"Camper Van: Make it Home",category:"puzzle",price:"Free",shortDescription:"Decorate and organize the camper van of your dreams! Build your own home-on-wheels using creative block organization puzzles and relaxing interior design.",rating:4.7,likesCount:29300,cardImage:"/assets/images/games/camper-van-make-it-home-card.jpg",featured:!1},{slug:"organized-inside",name:"Organized Inside",category:"puzzle",price:"Free",shortDescription:"A slow-paced life sim and tidying up game about a cat, passion, transformation and growth. Categorize household items while uncovering the meaning of life through organization.",rating:4.8,likesCount:22700,cardImage:"/assets/images/games/organized-inside-card.jpg",featured:!1},{slug:"cozy-solitaire",name:"Cozy Solitaire",category:"card",price:"Free",shortDescription:"Classic Solitaire game, accompanied by music and kitties.",rating:4.5,likesCount:38900,cardImage:"/assets/images/games/cozy-solitaire-card.jpg",featured:!1},{slug:"cozy-sudoku",name:"Cozy Sudoku",category:"puzzle",price:"Free",shortDescription:"Sudoku, tunes, and some furry friends.",rating:4.6,likesCount:21500,cardImage:"/assets/images/games/cozy-sudoku-card.jpg",featured:!1},{slug:"koroneko",name:"KoroNeko",category:"puzzle",price:"Free",shortDescription:"Roll your way through a cozy, kawaii world full of charming characters and challenging puzzles to save your siblings from Strawberry the Witch!",rating:4.9,likesCount:47300,cardImage:"/assets/images/games/koroneko-card.jpg",featured:!1},{slug:"wytchwood",name:"Wytchwood",category:"strategy",price:"$4.99",shortDescription:"A crafting adventure game set in a land of gothic fables. As the old witch, explore, collect ingredients, brew spells, and pass judgement upon a capricious cast of characters.",rating:4.7,likesCount:33100,cardImage:"/assets/images/games/wytchwood-card.jpg",featured:!1},{slug:"the-wild-at-heart",name:"The Wild at Heart",category:"strategy",price:"Free",shortDescription:"Wield a herd of quirky creatures to rebuild paths, battle beasts, and solve puzzles in a rich, interconnected nostalgic storybook fantasy world.",rating:4.8,likesCount:30400,cardImage:"/assets/images/games/the-wild-at-heart-card.jpg",featured:!1}],Xe={data:Ke},E=Object.assign({"../../assets/images/games/camper-van-make-it-home-card.jpg":be,"../../assets/images/games/cast-n-chill-card.jpg":ye,"../../assets/images/games/cat-chess-card.jpg":Ce,"../../assets/images/games/cat-mail-co-card.jpg":Y,"../../assets/images/games/cozy-solitaire-card.jpg":Le,"../../assets/images/games/cozy-sudoku-card.jpg":Ee,"../../assets/images/games/grimshire-card.jpg":Ae,"../../assets/images/games/heartopia-card.jpg":J,"../../assets/images/games/islanders-new-shores-card.jpg":ee,"../../assets/images/games/koroneko-card.jpg":xe,"../../assets/images/games/leaf-it-alone-card.jpg":Te,"../../assets/images/games/leafy-corner-card.jpg":Ie,"../../assets/images/games/little-corners-card.jpg":De,"../../assets/images/games/organized-inside-card.jpg":Be,"../../assets/images/games/palia-card.jpg":te,"../../assets/images/games/shelve-the-potions-card.jpg":ae,"../../assets/images/games/tailside-cozy-cafe-sim-card.jpg":se,"../../assets/images/games/the-wild-at-heart-card.jpg":Re,"../../assets/images/games/tiny-glade-card.jpg":ie,"../../assets/images/games/tukoni-forest-keepers-card.jpg":Ne,"../../assets/images/games/vacation-cafe-simulator-card.jpg":re,"../../assets/images/games/whisper-of-the-house-card.jpg":qe,"../../assets/images/games/winter-burrow-card.jpg":oe,"../../assets/images/games/wytchwood-card.jpg":Ve});class Qe{constructor(e={}){r(this,"element");r(this,"games");r(this,"activeCategory","all");r(this,"activeSort","Popular");r(this,"currentPage",1);r(this,"totalPages",4);r(this,"isSortOpen",!1);r(this,"callbacks");this.callbacks=e,this.games=Xe.data,this.element=this.createPageElement(),this.setupInteractivity()}getElement(){return this.element}getGameImageUrl(e){const s=`../../assets/images/games/${e}-card.jpg`;return E[s]?E[s].default:""}createPageElement(){const e=document.createElement("div");e.className="library-page";const s=Ze.data,a=["Popular","Rating","Newest","Price: Low to High"];return e.innerHTML=`
      ...
      <section class="library-grid-section" aria-label="Games list">
        <div class="library-grid-section__grid">
          ${this.games.map(t=>{const i=this.getGameImageUrl(t.slug);return`
              <article class="library-card" data-slug="${t.slug}">
                <div class="library-card__thumb-wrap">
                  <img src="${i}" alt="${t.name}" class="library-card__image" loading="lazy" />
                ...
                <div class="library-card__body">
                  <span class="library-card__category">${t.category}</span>
                  <h2 class="library-card__title">${t.name}</h2>
                  <p class="library-card__description">${t.shortDescription}</p>
                  <div class="library-card__footer">
                    <span class="library-card__price ${t.price==="Free"?"":"library-card__price--paid"}">${t.price}</span>
                    <button type="button" class="library-card__details-btn" data-slug="${t.slug}">Details</button>
                  </div>
                </div>
              </article>
            `}).join("")}
    ...
    `,e}setupInteractivity(){const e=this.element.querySelectorAll(".library-filter-section__chip");for(const c of e)c.addEventListener("click",()=>{const u=c.dataset.category;if(u){this.activeCategory=u;for(const p of e){const v=p.dataset.category===u;p.classList.toggle("library-filter-section__chip--active",v),p.setAttribute("aria-selected",v.toString())}}});const s=this.element.querySelector(".library-filter-section__chips-wrapper");if(s){let c=!1,u=0,p=0;s.addEventListener("mousedown",v=>{c=!0,u=v.pageX-s.offsetLeft,p=s.scrollLeft}),s.addEventListener("mouseleave",()=>{c=!1}),s.addEventListener("mouseup",()=>{c=!1}),s.addEventListener("mousemove",v=>{if(!c)return;v.preventDefault();const d=(v.pageX-s.offsetLeft-u)*1.5;s.scrollLeft=p-d})}const a=this.element.querySelector(".library-filter-section__sort-btn"),t=this.element.querySelector(".library-filter-section__sort-dropdown"),i=this.element.querySelectorAll(".library-filter-section__sort-item"),n=this.element.querySelector(".sort-current-label");if(a&&t){a.addEventListener("click",c=>{c.stopPropagation(),this.isSortOpen=!this.isSortOpen,a.classList.toggle("library-filter-section__sort-btn--open",this.isSortOpen),t.classList.toggle("library-filter-section__sort-dropdown--open",this.isSortOpen),a.setAttribute("aria-expanded",this.isSortOpen.toString())});for(const c of i)c.addEventListener("click",()=>{const u=c.dataset.sort;if(u){this.activeSort=u,n&&(n.textContent=u);for(const p of i)p.classList.toggle("library-filter-section__sort-item--active",p.dataset.sort===u);this.isSortOpen=!1,a.classList.remove("library-filter-section__sort-btn--open"),t.classList.remove("library-filter-section__sort-dropdown--open"),a.setAttribute("aria-expanded","false")}});document.addEventListener("click",c=>{this.element.contains(c.target)||(this.isSortOpen=!1,a.classList.remove("library-filter-section__sort-btn--open"),t.classList.remove("library-filter-section__sort-dropdown--open"),a.setAttribute("aria-expanded","false"))})}const m=this.element.querySelectorAll(".library-card__details-btn");for(const c of m)c.addEventListener("click",()=>{var v,y;const u=c.dataset.slug,p=this.games.find(d=>d.slug===u);p&&((y=(v=this.callbacks).onGameDetailsClick)==null||y.call(v,p))});const h=this.element.querySelector(".library-pagination__arrow-btn--prev"),o=this.element.querySelector(".library-pagination__arrow-btn--next"),_=this.element.querySelectorAll(".library-pagination__page-btn"),b=c=>{this.currentPage=c,h&&(h.disabled=this.currentPage===1),o&&(o.disabled=this.currentPage===this.totalPages);for(const u of _){const p=Number(u.dataset.page);u.classList.toggle("library-pagination__page-btn--active",p===c)}};for(const c of _)c.addEventListener("click",()=>{const u=Number(c.dataset.page);u&&b(u)});h&&h.addEventListener("click",()=>{this.currentPage>1&&b(this.currentPage-1)}),o&&o.addEventListener("click",()=>{this.currentPage<this.totalPages&&b(this.currentPage+1)})}}class Ye{constructor(e){r(this,"routes",[]);r(this,"rootElement");r(this,"currentPath","");this.rootElement=e,window.addEventListener("popstate",()=>{this.handleRoute()}),window.addEventListener("hashchange",()=>{this.handleRoute()})}addRoute(e){this.routes.push(e)}navigate(e){window.location.hash=e.startsWith("#")?e:`#${e}`}getCurrentRoute(){return window.location.hash.replace(/^#\/?/,"")==="library"||window.location.pathname.replaceAll(/^\/|\/$/g,"").endsWith("library")?"library":"home"}handleRoute(){const s=this.getCurrentRoute()==="library"?"/library":"/";if(this.currentPath===s&&this.rootElement.children.length>0)return;this.currentPath=s;const a=this.routes.find(t=>t.path===s);if(this.rootElement.innerHTML="",a)this.rootElement.append(a.render());else{const t=this.routes.find(i=>i.path==="/");t&&this.rootElement.append(t.render())}}}function Je(){var h;const g=document.querySelector("#app");if(!g)return;const e=new Ye(g),s=new H,a=new q,t=new Q({activePage:"home",onLoginClick:()=>{s.open("login")},onSignUpClick:()=>{s.open("register")},onNavigate:o=>{e.navigate(o==="library"?"/library":"/")}}),i=new X,m=i.getElement().querySelectorAll(".site-footer__link");for(const o of m){const _=(h=o.textContent)==null?void 0:h.trim().toLowerCase();_==="home"?o.addEventListener("click",b=>{b.preventDefault(),t.setActivePage("home"),e.navigate("/")}):_==="library"&&o.addEventListener("click",b=>{b.preventDefault(),t.setActivePage("library"),e.navigate("/library")})}e.addRoute({path:"/",render:()=>{t.setActivePage("home");const o=document.createElement("div");o.className="app-container app-container--home",o.append(t.getElement());const _=document.createElement("main");_.className="main-content";const b=new ge,c=new ne({onGameClick:()=>{a.open()}}),u=new _e,p=new de;return _.append(b.getElement(),c.getElement(),u.getElement(),p.getElement()),o.append(_,i.getElement()),o}}),e.addRoute({path:"/library",render:()=>{t.setActivePage("library");const o=document.createElement("div");o.className="app-container app-container--library",o.append(t.getElement());const _=document.createElement("main");_.className="main-content";const b=new Qe({onGameDetailsClick:()=>{a.open()}});return _.append(b.getElement()),o.append(_,i.getElement()),o}}),e.handleRoute()}document.addEventListener("DOMContentLoaded",()=>{Je()});
