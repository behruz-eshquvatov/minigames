var F=Object.defineProperty;var B=(m,e,s)=>e in m?F(m,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):m[e]=s;var o=(m,e,s)=>B(m,typeof e!="symbol"?e+"":e,s);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function s(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerPolicy&&(i.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?i.credentials="include":t.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(t){if(t.ep)return;t.ep=!0;const i=s(t);fetch(t.href,i)}})();class R{constructor(){o(this,"element");o(this,"backdrop");o(this,"dialogCard");o(this,"currentMode","login");o(this,"isOpen",!1);o(this,"handleKeyDown",e=>{e.key==="Escape"&&this.close()});this.backdrop=document.createElement("div"),this.backdrop.className="auth-backdrop",this.dialogCard=document.createElement("div"),this.dialogCard.className="auth-dialog",this.backdrop.append(this.dialogCard),this.element=this.backdrop,this.renderContent(),this.attachEvents()}getElement(){return this.element}open(e="login"){this.currentMode=e,this.renderContent(),document.body.append(this.element),this.isOpen=!0,requestAnimationFrame(()=>{this.backdrop.classList.add("auth-backdrop--active"),this.dialogCard.classList.add("auth-dialog--active")}),document.addEventListener("keydown",this.handleKeyDown)}close(){this.isOpen&&(this.backdrop.classList.remove("auth-backdrop--active"),this.dialogCard.classList.remove("auth-dialog--active"),setTimeout(()=>{this.element.parentNode&&this.element.remove(),this.isOpen=!1},250),document.removeEventListener("keydown",this.handleKeyDown))}attachEvents(){this.backdrop.addEventListener("click",e=>{e.target===this.backdrop&&this.close()})}switchMode(e){if(this.currentMode===e)return;this.currentMode=e;const s=this.dialogCard.querySelector(".auth-dialog__form-container");s?(s.classList.add("auth-dialog__form-container--transitioning"),setTimeout(()=>{this.renderContent();const a=this.dialogCard.querySelector(".auth-dialog__form-container");a&&a.classList.remove("auth-dialog__form-container--transitioning")},150)):this.renderContent()}renderContent(){const e=this.currentMode==="login";this.dialogCard.innerHTML=`
    ...
    `;const s=this.dialogCard.querySelectorAll(".auth-dialog__switcher-btn");for(const r of s)r.addEventListener("click",()=>{const n=r.dataset.mode;this.switchMode(n)});const a=this.dialogCard.querySelectorAll(".auth-switch-link");for(const r of a)r.addEventListener("click",n=>{n.preventDefault();const g=r.dataset.mode;this.switchMode(g)});const t=this.dialogCard.querySelectorAll(".auth-field__toggle-pwd");for(const r of t)r.addEventListener("click",()=>{var g;const n=(g=r.parentElement)==null?void 0:g.querySelector("input");if(n){const c=n.type==="password";n.type=c?"text":"password",r.innerHTML=c?this.getEyeOffIconSvg():this.getEyeIconSvg()}});const i=this.dialogCard.querySelector("form");i&&i.addEventListener("submit",r=>{r.preventDefault()})}renderLoginForm(){return`
      ...
      <div class="game-details-dialog" role="dialog" aria-modal="true" aria-labelledby="game-details-title">
        <div class="game-details-dialog__content">
          ...
          <div class="game-details-dialog__hero">
            <img src="${$}" alt="${s.name}" class="game-details-dialog__hero-image" />
    ...
    `,e}}class Q{constructor(e={}){o(this,"element");o(this,"isMenuOpen",!1);o(this,"burgerButton");o(this,"mobileMenuOverlay");o(this,"callbacks");o(this,"activePage");this.callbacks=e,this.activePage=e.activePage||"home",this.element=this.createHeaderElement(),this.setupEventListeners()}getElement(){return this.element}setActivePage(e){this.activePage=e;const s=this.element.querySelectorAll(".site-header__nav-link");for(const t of s){const i=t.dataset.page;t.classList.toggle("site-header__nav-link--active",i===e)}const a=this.mobileMenuOverlay.querySelectorAll(".mobile-menu__nav-link");for(const t of a){const i=t.dataset.page;t.classList.toggle("mobile-menu__nav-link--active",i===e)}}createHeaderElement(){const e=document.createElement("header");e.className="site-header";const s=document.createElement("div");s.className="site-header__container";const a=document.createElement("a");a.href="#",a.className="site-header__logo",a.innerHTML=`
    ...
    `,a.addEventListener("click",h=>{var d,f;h.preventDefault(),this.setActivePage("home"),(f=(d=this.callbacks).onNavigate)==null||f.call(d,"home")});const t=document.createElement("nav");t.className="site-header__nav",t.innerHTML=`
    ...
    `;const i=t.querySelector('[data-page="home"]');i&&i.addEventListener("click",h=>{var d,f;h.preventDefault(),this.setActivePage("home"),(f=(d=this.callbacks).onNavigate)==null||f.call(d,"home")});const r=t.querySelector('[data-page="library"]');r&&r.addEventListener("click",h=>{var d,f;h.preventDefault(),this.setActivePage("library"),(f=(d=this.callbacks).onNavigate)==null||f.call(d,"library")});const n=document.createElement("button");n.className="btn btn--outline site-header__login-btn",n.textContent="Log In",n.addEventListener("click",()=>{var h,d;this.closeMobileMenu(),(d=(h=this.callbacks).onLoginClick)==null||d.call(h)});const g=document.createElement("button");g.className="btn btn--primary site-header__signup-btn",g.textContent="Sign Up",g.addEventListener("click",()=>{var h,d;this.closeMobileMenu(),(d=(h=this.callbacks).onSignUpClick)==null||d.call(h)});const c=document.createElement("div");c.className="site-header__nav-wrapper",c.append(t,n),this.burgerButton=document.createElement("button"),this.burgerButton.className="site-header__burger-btn",this.burgerButton.setAttribute("aria-label","Toggle menu"),this.burgerButton.innerHTML=`
      <span class="site-header__burger-icon">
        <span class="site-header__burger-line"></span>
        <span class="site-header__burger-line"></span>
        <span class="site-header__burger-line"></span>
      </span>
    `;const p=document.createElement("div");p.className="site-header__right-controls",p.append(c,g,this.burgerButton),s.append(a,p),e.append(s),this.mobileMenuOverlay=document.createElement("div"),this.mobileMenuOverlay.className="mobile-menu",this.mobileMenuOverlay.innerHTML=`
    ...
    `,e}}class ge{constructor(){o(this,"element");this.element=this.createHeroElement()}getElement(){return this.element}createHeroElement(){const e=document.createElement("section");return e.className="hero-section",e.innerHTML=`
    ...
    `,e}getFilteredAndSortedGames(){let e=[...this.games];switch(this.activeCategory!=="all"&&(e=e.filter(s=>s.category.toLowerCase()===this.activeCategory.toLowerCase())),this.activeSort){case"Rating ↑":{e.sort((s,a)=>s.rating-a.rating);break}case"Rating ↓":{e.sort((s,a)=>a.rating-s.rating);break}case"Name A→Z":{e.sort((s,a)=>s.name.localeCompare(a.name));break}case"Name Z→A":{e.sort((s,a)=>a.name.localeCompare(s.name));break}}return e}renderCards(){const e=this.element.querySelector(".library-grid-section__grid");if(!e)return;const s=this.getFilteredAndSortedGames();this.totalPages=Math.max(1,Math.ceil(s.length/this.itemsPerPage));const a=(this.currentPage-1)*this.itemsPerPage,t=s.slice(a,a+this.itemsPerPage);e.innerHTML=t.map(r=>{const n=this.getGameImageUrl(r.slug),g=this.formatLikes(r.likesCount);return`
      ...
      `}).join("");const i=e.querySelectorAll(".library-card__details-btn");for(const r of i)r.addEventListener("click",()=>{var c,p;const n=r.dataset.slug,g=this.games.find(l=>l.slug===n);g&&((p=(c=this.callbacks).onGameDetailsClick)==null||p.call(c,g))})}setupInteractivity(){const e=this.element.querySelector(".library-pagination__arrow-btn--prev"),s=this.element.querySelector(".library-pagination__arrow-btn--next"),a=this.element.querySelectorAll(".library-pagination__page-btn"),t=l=>{this.currentPage=Math.min(l,this.totalPages),e&&(e.disabled=this.currentPage<=1),s&&(s.disabled=this.currentPage>=this.totalPages);for(const u of a){const _=Number(u.dataset.page);u.classList.toggle("library-pagination__page-btn--active",_===this.currentPage),u.style.display=_>this.totalPages?"none":""}this.renderCards()},i=this.element.querySelectorAll(".library-filter-section__chip");for(const l of i)l.addEventListener("click",()=>{const u=l.dataset.category;if(u){this.activeCategory=u;for(const _ of i){const b=_.dataset.category===u;_.classList.toggle("library-filter-section__chip--active",b),_.setAttribute("aria-selected",b.toString())}t(1)}});const r=this.element.querySelector(".library-filter-section__chips-wrapper");if(r){let l=!1,u=0,_=0;r.addEventListener("mousedown",b=>{l=!0,u=b.pageX-r.offsetLeft,_=r.scrollLeft}),r.addEventListener("mouseleave",()=>{l=!1}),r.addEventListener("mouseup",()=>{l=!1}),r.addEventListener("mousemove",b=>{if(!l)return;b.preventDefault();const y=(b.pageX-r.offsetLeft-u)*1.5;r.scrollLeft=_-y})}const n=this.element.querySelector(".library-filter-section__sort-btn"),g=this.element.querySelector(".library-filter-section__sort-dropdown"),c=this.element.querySelectorAll(".library-filter-section__sort-item"),p=this.element.querySelector(".sort-current-label");if(n&&g){n.addEventListener("click",l=>{l.stopPropagation(),this.isSortOpen=!this.isSortOpen,n.classList.toggle("library-filter-section__sort-btn--open",this.isSortOpen),g.classList.toggle("library-filter-section__sort-dropdown--open",this.isSortOpen),n.setAttribute("aria-expanded",this.isSortOpen.toString())});for(const l of c)l.addEventListener("click",()=>{const u=l.dataset.sort;if(u){this.activeSort=u,p&&(p.textContent=u);for(const _ of c){const b=_.dataset.sort===u;_.classList.toggle("library-filter-section__sort-item--active",b);const v=_.querySelector(".library-filter-section__sort-check");v&&(v.textContent=b?"✔":"")}this.isSortOpen=!1,n.classList.remove("library-filter-section__sort-btn--open"),g.classList.remove("library-filter-section__sort-dropdown--open"),n.setAttribute("aria-expanded","false"),t(1)}});document.addEventListener("click",l=>{this.element.contains(l.target)||(this.isSortOpen=!1,n.classList.remove("library-filter-section__sort-btn--open"),g.classList.remove("library-filter-section__sort-dropdown--open"),n.setAttribute("aria-expanded","false"))})}for(const l of a)l.addEventListener("click",()=>{const u=Number(l.dataset.page);u&&t(u)});e&&e.addEventListener("click",()=>{this.currentPage>1&&t(this.currentPage-1)}),s&&s.addEventListener("click",()=>{this.currentPage<this.totalPages&&t(this.currentPage+1)})}}class Ye{constructor(e){o(this,"routes",[]);o(this,"rootElement");o(this,"currentPath","");this.rootElement=e,window.addEventListener("popstate",()=>{this.handleRoute()}),window.addEventListener("hashchange",()=>{this.handleRoute()})}addRoute(e){this.routes.push(e)}navigate(e){window.location.hash=e.startsWith("#")?e:`#${e}`}getCurrentRoute(){return window.location.hash.replace(/^#\/?/,"")==="library"||window.location.pathname.replaceAll(/^\/|\/$/g,"").endsWith("library")?"library":"home"}handleRoute(){const s=this.getCurrentRoute()==="library"?"/library":"/";if(this.currentPath===s&&this.rootElement.children.length>0)return;this.currentPath=s;const a=this.routes.find(t=>t.path===s);if(this.rootElement.innerHTML="",a)this.rootElement.append(a.render());else{const t=this.routes.find(i=>i.path==="/");t&&this.rootElement.append(t.render())}}}function Je(){var g;const m=document.querySelector("#app");if(!m)return;const e=new Ye(m),s=new R,a=new q,t=new Q({activePage:"home",onLoginClick:()=>{s.open("login")},onSignUpClick:()=>{s.open("register")},onNavigate:c=>{e.navigate(c==="library"?"/library":"/")}}),i=new X,n=i.getElement().querySelectorAll(".site-footer__link");for(const c of n){const p=(g=c.textContent)==null?void 0:g.trim().toLowerCase();p==="home"?c.addEventListener("click",l=>{l.preventDefault(),t.setActivePage("home"),e.navigate("/")}):p==="library"&&c.addEventListener("click",l=>{l.preventDefault(),t.setActivePage("library"),e.navigate("/library")})}e.addRoute({path:"/",render:()=>{t.setActivePage("home");const c=document.createElement("div");c.className="app-container app-container--home",c.append(t.getElement());const p=document.createElement("main");p.className="main-content";const l=new ge,u=new ne({onGameClick:()=>{a.open()}}),_=new _e,b=new de;return p.append(l.getElement(),u.getElement(),_.getElement(),b.getElement()),c.append(p,i.getElement()),c}}),e.addRoute({path:"/library",render:()=>{t.setActivePage("library");const c=document.createElement("div");c.className="app-container app-container--library",c.append(t.getElement());const p=document.createElement("main");p.className="main-content";const l=new Qe({onGameDetailsClick:()=>{a.open()}});return p.append(l.getElement()),c.append(p,i.getElement()),c}}),e.handleRoute()}document.addEventListener("DOMContentLoaded",()=>{Je()});
