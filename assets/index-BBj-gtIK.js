var N=Object.defineProperty;var $=(g,e,s)=>e in g?N(g,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):g[e]=s;var o=(g,e,s)=>$(g,typeof e!="symbol"?e+"":e,s);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))t(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&t(r)}).observe(document,{childList:!0,subtree:!0});function s(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function t(a){if(a.ep)return;a.ep=!0;const i=s(a);fetch(a.href,i)}})();const H=250,G=150;class q{constructor(){o(this,"element");o(this,"backdrop");o(this,"dialogCard");o(this,"currentMode","login");o(this,"isOpen",!1);o(this,"handleKeyDown",e=>{e.key==="Escape"&&this.close()});this.backdrop=document.createElement("div"),this.backdrop.className="auth-backdrop",this.dialogCard=document.createElement("div"),this.dialogCard.className="auth-dialog",this.backdrop.append(this.dialogCard),this.element=this.backdrop,this.renderContent(),this.attachEvents()}getElement(){return this.element}open(e="login"){this.currentMode=e,this.renderContent(),document.body.append(this.element),this.isOpen=!0,requestAnimationFrame(()=>{this.backdrop.classList.add("auth-backdrop--active"),this.dialogCard.classList.add("auth-dialog--active")}),document.addEventListener("keydown",this.handleKeyDown)}close(){this.isOpen&&(this.backdrop.classList.remove("auth-backdrop--active"),this.dialogCard.classList.remove("auth-dialog--active"),setTimeout(()=>{this.element.parentNode&&this.element.remove(),this.isOpen=!1},H),document.removeEventListener("keydown",this.handleKeyDown))}attachEvents(){this.backdrop.addEventListener("click",e=>{e.target===this.backdrop&&this.close()})}switchMode(e){if(this.currentMode===e)return;this.currentMode=e;const s=this.dialogCard.querySelector(".auth-dialog__form-container");s?(s.classList.add("auth-dialog__form-container--transitioning"),setTimeout(()=>{this.renderContent();const t=this.dialogCard.querySelector(".auth-dialog__form-container");t&&t.classList.remove("auth-dialog__form-container--transitioning")},G)):this.renderContent()}renderContent(){const e=this.currentMode==="login";this.dialogCard.innerHTML=`
      ...
      <div class="game-details-dialog" role="dialog" aria-modal="true" aria-labelledby="game-details-title">
        <div class="game-details-dialog__content">
          ...
          <div class="game-details-dialog__hero">
            <img src="${U}" alt="${s.name}" class="game-details-dialog__hero-image" />
      ...
      <div class="site-footer__container">
        ...
        <div class="site-footer__bottom">
          ...
          <a href="https://rs.school/courses/short-track" target="_blank" rel="noopener noreferrer" class="site-footer__credit-link">
            <img src="${se}" alt="RS School Logo" class="site-footer__rs-logo" />
            <span>RS School</span>
          </a>

          <a href="https://github.com/behruz-eshquvatov" target="_blank" rel="noopener noreferrer" class="site-footer__credit-link">
            <img src="${ie}" alt="GitHub Logo" class="site-footer__github-logo" />
    ...
    `;const l=this.mobileMenuOverlay.querySelector(".mobile-menu__logo");l&&l.addEventListener("click",p=>{var m,f;p.preventDefault(),this.closeMobileMenu(),this.setActivePage("home"),(f=(m=this.callbacks).onNavigate)==null||f.call(m,"home")});const h=this.mobileMenuOverlay.querySelector('[data-page="home"]');h&&h.addEventListener("click",p=>{var m,f;p.preventDefault(),this.closeMobileMenu(),this.setActivePage("home"),(f=(m=this.callbacks).onNavigate)==null||f.call(m,"home")});const _=this.mobileMenuOverlay.querySelector('[data-page="library"]');_&&_.addEventListener("click",p=>{var m,f;p.preventDefault(),this.closeMobileMenu(),this.setActivePage("library"),(f=(m=this.callbacks).onNavigate)==null||f.call(m,"library")});const v=this.mobileMenuOverlay.querySelector(".mobile-menu__close-btn");v&&v.addEventListener("click",()=>{this.closeMobileMenu()});const b=this.mobileMenuOverlay.querySelector(".mobile-menu__login-btn");b&&b.addEventListener("click",()=>{var p,m;this.closeMobileMenu(),(m=(p=this.callbacks).onLoginClick)==null||m.call(p)});const y=this.mobileMenuOverlay.querySelector(".mobile-menu__signup-btn");return y&&y.addEventListener("click",()=>{var p,m;this.closeMobileMenu(),(m=(p=this.callbacks).onSignUpClick)==null||m.call(p)}),e.append(this.mobileMenuOverlay),e}setupEventListeners(){this.burgerButton.addEventListener("click",()=>{this.toggleMobileMenu()}),document.addEventListener("keydown",e=>{e.key==="Escape"&&this.isMenuOpen&&this.closeMobileMenu()})}toggleMobileMenu(){this.isMenuOpen?this.closeMobileMenu():this.openMobileMenu()}openMobileMenu(){this.isMenuOpen=!0,this.burgerButton.classList.add("site-header__burger-btn--open"),this.mobileMenuOverlay.classList.add("mobile-menu--open"),document.body.style.overflow="hidden"}closeMobileMenu(){this.isMenuOpen=!1,this.burgerButton.classList.remove("site-header__burger-btn--open"),this.mobileMenuOverlay.classList.remove("mobile-menu--open"),document.body.style.overflow=""}}const k="data:image/svg+xml,%3csvg%20width='16'%20height='16'%20viewBox='0%200%2016%2016'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M3.825%209L9.425%2014.6L8%2016L1.19209e-07%208L8%20-9.53674e-07L9.425%201.4L3.825%207H16V9H3.825Z'%20fill='%23242145'/%3e%3c/svg%3e",T=""+new URL("cat-mail-co-card-B0GMTC_n.jpg",import.meta.url).href,ne=Object.freeze(Object.defineProperty({__proto__:null,default:T},Symbol.toStringTag,{value:"Module"})),z=""+new URL("heartopia-card-DRd_6OVG.jpg",import.meta.url).href,le=Object.freeze(Object.defineProperty({__proto__:null,default:z},Symbol.toStringTag,{value:"Module"})),I=""+new URL("islanders-new-shores-card-DljrohUL.jpg",import.meta.url).href,ce=Object.freeze(Object.defineProperty({__proto__:null,default:I},Symbol.toStringTag,{value:"Module"})),P=""+new URL("palia-card-8xT8yeZQ.jpg",import.meta.url).href,de=Object.freeze(Object.defineProperty({__proto__:null,default:P},Symbol.toStringTag,{value:"Module"})),O=""+new URL("shelve-the-potions-card-DTY_N_zq.jpg",import.meta.url).href,me=Object.freeze(Object.defineProperty({__proto__:null,default:O},Symbol.toStringTag,{value:"Module"})),D=""+new URL("tailside-cozy-cafe-sim-card-C7B0rePC.jpg",import.meta.url).href,ge=Object.freeze(Object.defineProperty({__proto__:null,default:D},Symbol.toStringTag,{value:"Module"})),F=""+new URL("tiny-glade-card-CS2XLEzK.jpg",import.meta.url).href,ue=Object.freeze(Object.defineProperty({__proto__:null,default:F},Symbol.toStringTag,{value:"Module"})),R=""+new URL("vacation-cafe-simulator-card-Bzcyczbo.jpg",import.meta.url).href,he=Object.freeze(Object.defineProperty({__proto__:null,default:R},Symbol.toStringTag,{value:"Module"})),B=""+new URL("winter-burrow-card-KbzzF82b.jpg",import.meta.url).href,pe=Object.freeze(Object.defineProperty({__proto__:null,default:B},Symbol.toStringTag,{value:"Module"})),_e=5,M=420,fe=4e3,ve=40;class be{constructor(e={}){o(this,"element");o(this,"games",[{slug:"vacation-cafe-simulator",name:"Vacation Cafe Simulator",rating:4.8,likesCount:28750,likesFormatted:"28.7K",cardImage:R},{slug:"winter-burrow",name:"Winter Burrow",rating:4.9,likesCount:32400,likesFormatted:"32.4K",cardImage:B},{slug:"shelve-the-potions",name:"Shelve the Potions!",rating:4.7,likesCount:21300,likesFormatted:"21.3K",cardImage:O},{slug:"heartopia",name:"Heartopia",rating:4.6,likesCount:46800,likesFormatted:"46.8K",cardImage:z},{slug:"palia",name:"Palia",rating:4.9,likesCount:42100,likesFormatted:"42.1K",cardImage:P},{slug:"cat-mail-co",name:"Cat Mail Co.",rating:4.8,likesCount:38900,likesFormatted:"38.9K",cardImage:T},{slug:"tiny-glade",name:"Tiny Glade",rating:4.9,likesCount:51200,likesFormatted:"51.2K",cardImage:F},{slug:"tailside-cozy-cafe-sim",name:"Tailside: Cozy Cafe Sim",rating:4.8,likesCount:18400,likesFormatted:"18.4K",cardImage:D},{slug:"islanders-new-shores",name:"ISLANDERS: New Shores",rating:4.9,likesCount:54200,likesFormatted:"54.2K",cardImage:I}]);o(this,"centerIndex",0);o(this,"autoplayTimer");o(this,"callbacks");o(this,"startX",0);o(this,"isSwiping",!1);o(this,"hasSwiped",!1);o(this,"isAnimating",!1);this.callbacks=e,this.element=this.createCarouselElement(),this.renderTrack(),this.setupControls(),this.startAutoplay()}getElement(){return this.element}createCarouselElement(){const e=document.createElement("section");return e.className="carousel-section",e.innerHTML=`
        ...
        <div class="game-dev-card">
          ...
          <div class="game-dev-card__actions">
            <button class="game-dev-card__btn" aria-label="Submit Form">
              <img src="${ke}" alt="Upload icon" class="game-dev-card__upload-icon" width="16" height="16" />
              Submit Form
            </button>
    ...
    `,e}}class we{constructor(){o(this,"element");this.element=this.createHeroElement()}getElement(){return this.element}createHeroElement(){const e=document.createElement("section");return e.className="hero-section",e.innerHTML=`
                ...
                <tr class="leaderboard-row leaderboard-row--rank-${t.rank}">
                  ...
                  <td class="col-player">
                    <div class="player-info">
                      <span class="player-avatar" style="background-color: ${Ee[t.rank]||"#E0EEF6"}">
                        ${Ae(t.playerName)}
                      </span>
                  ...
                  <td class="col-score">
                    <span class="score-desktop">${x(t.totalScore,!1)}</span>
                    <span class="score-mobile">${x(t.totalScore,!0)}</span>
                  </td>
                  <td class="col-streak">
